...
describe('/unpublish-app', () => {
  describe('UnpublishApp#BEFORE', () => {
    it('should require appid', async () => {
      const req = TestHelper.createRequest('/unpublish-app?appid=', 'GET')
      let errorMessage
      try {
    ...
    it('should require own appid', async () => {
      ...
      const req = TestHelper.createRequest(`/unpublish-app?appid=${app1.appid}`, 'GET')
    ...
    it('should reject never-published app', async () => {
      ...
      const req = TestHelper.createRequest(`/unpublish-app?appid=${app.appid}`, 'GET')
  ...
  describe('UnpublishApp#POST', () => {
    it('should apply after authorization', async () => {
      ...
      const app = await TestHelper.createApp(user, { url: 'https://something', stripeid: 'stripe_1', published: true, application_fee: '0.05' })
      const req = TestHelper.createRequest(`/unpublish-app?appid=${app.appid}`, 'POST')
      req.account = user.account
      req.session = user.session
      const res = TestHelper.createResponse()
      res.end = async (str) => {
