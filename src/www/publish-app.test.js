...
describe('/publish-app', () => {
  describe('PublishApp#BEFORE', () => {
    it('should require appid', async () => {
      const req = TestHelper.createRequest('/publish-app?appid=', 'GET')
      let errorMessage
      try {
    ...
    it('should require own appid', async () => {
      ...
      const req = TestHelper.createRequest(`/publish-app?appid=${app1.appid}`, 'GET')
    ...
    it('should reject published app', async () => {
      ...
      const req = TestHelper.createRequest(`/publish-app?appid=${app.appid}`, 'GET')
  ...
  describe('PublishApp#POST', () => {
    it('should apply after authorization', async () => {
      ...
      const app = await TestHelper.createApp(user, { url: 'https://something', stripeid: 'stripe_1', application_fee: '0.05' })
      const req = TestHelper.createRequest(`/publish-app?appid=${app.appid}`, 'POST')
      req.account = user.account
      req.session = user.session
      const res = TestHelper.createResponse()
      res.end = async (str) => {
