...
describe('internal-api/html', async () => {
  describe('HTML#parseHTML()', async () => {
  ...
  describe('HTML#findOrCreateTableBody()', async () => {
    ...
    it('should require a table', async () => {
      ...
      let errorMessage
      try {
        HTML.findOrCreateTableBody(doc)
      } catch (error) {
        errorMessage = error.message
      }
    ...
    it('should return existing TBODY', async () => {
      ...
      HTML.findOrCreateTableBody(doc, 'table')
      assert.strictEqual(doc.getElementsByTagName('tbody')[0].attr.id, 'existing-tbody')
    })
    ...
    it('should create new TBODY as last child of table', async () => {
      ...
      assert.strictEqual(table.child[0].tag, 'tr')
      assert.strictEqual(table.child[1].tag, 'tbody')
    })
  })

  describe('HTML#renderTable()', async () => {
    it('should require a document', async () => {
      let errorMessage
      try {
  ...
  describe('HTML#renderList()', async () => {
    it('should require a document', async () => {
      let errorMessage
      try {
  ...
  describe('HTML#renderTemplate()', async () => {
    it('should require a document', async () => {
      let errorMessage
      try {
  ...
  describe('HTML#renderPagination()', async () => {
    it('should require a document', async () => {
      let errorMessage
      try {
